...
2. Get the code:
   ...
   .. code-block:: bash
       ...
       $ git clone git@bitbucket.org:maykinmedia/icindirect.git
       $ cd icindirect
...
``src/icindirect/conf/local.py``. You can base this file on the
...
.. code-block:: bash
    ...
    $ python src/manage.py test icindirect
...
2. Start the database and web services:
   ...
   .. code-block:: bash
       ...
       $ docker-compose up -d
       Starting icindirect_db_1 ... done
       Starting icindirect_web_1 ... done
   ...
   .. code-block:: bash
       ...
       $ docker logs -f icindirect_web_1
...
3. Create an admin user and load initial data. If different container names
   ...
   .. code-block:: bash
       ...
       $ docker exec -it icindirect_web_1 /app/src/manage.py createsuperuser
       Username: admin
       ...
       Superuser created successfully.

       $ docker exec -it icindirect_web_1 /app/src/manage.py loaddata admin_index groups
...
.. _Github: https://github.com/maykinmedia/icindirect/
...
environment variables. See ``src/icindirect/conf/docker.py`` for
all settings.
...
.. code-block:: bash
    ...
    $ docker build . && docker run \
        -p 8000:8000 \
        -e DJANGO_SETTINGS_MODULE=icindirect.conf.docker \
        -e DATABASE_USERNAME=... \
        -e DATABASE_PASSWORD=... \
        -e DATABASE_HOST=... \
        --name icindirect

    $ docker exec -it icindirect /app/src/manage.py createsuperuser
